...
build_coef_list <- function() {
  list(
    "barriers_total" = "Total legal barriers",
    "barriers_total_lag1" = "Total legal barriers (t - 1)",
    "barriers_total_within" = "Total legal barriers (within)",
    "barriers_total_between" = "Total legal barriers (between)",
    "barriers_total_lag1_within" = "Total legal barriers (within; t - 1)",
    "barriers_total_lag1_between" = "Total legal barriers (between; t - 1)",
    "advocacy" = "Barriers to advocacy",
    "advocacy_lag1" = "Barriers to advocacy (t - 1)",
    "advocacy_within" = "Barriers to advocacy (within)",
    "advocacy_between" = "Barriers to advocacy (between)",
    "advocacy_lag1_within" = "Barriers to advocacy (within; t - 1)",
    "advocacy_lag1_between" = "Barriers to advocacy (between; t - 1)",
    "entry" = "Barriers to entry",
    "entry_lag1" = "Barriers to entry (t - 1)",
    "entry_within" = "Barriers to entry (within)",
    "entry_between" = "Barriers to entry (between)",
    "entry_lag1_within" = "Barriers to entry (within; t - 1)",
    "entry_lag1_between" = "Barriers to entry (between; t - 1)",
    "funding" = "Barriers to funding",
    "funding_lag1" = "Barriers to funding (t - 1)",
    "funding_within" = "Barriers to funding (within)",
    "funding_between" = "Barriers to funding (between)",
    "funding_lag1_within" = "Barriers to funding (within; t - 1)",
    "funding_lag1_between" = "Barriers to funding (between; t - 1)",
    "v2csreprss" = "Civil society repression",
    "v2csreprss_lag1" = "Civil society repression (t - 1)",
    "v2csreprss_within" = "Civil society repression (within)",
    "v2csreprss_between" = "Civil society repression (between)",
    "v2csreprss_lag1_within" = "Civil society repression (within; t - 1)",
    "v2csreprss_lag1_between" = "Civil society repression (between; t - 1)",
    "PTS_factorLevel2" = "PTS = 2",
    "PTS_factorLevel3" = "PTS = 3",
    "PTS_factorLevel4" = "PTS = 4",
    "PTS_factorLevel5" = "PTS = 5",
    "v2x_clphy" = "Physical violence index (t)",
    "v2x_clpriv" = "Physical violence index (t)",
    "v2x_polyarchy" = "Polyarchy index",
    "v2x_polyarchy_within" = "Polyarchy index (within)",
    "v2x_polyarchy_between" = "Polyarchy index (between)",
    "gdpcap_log" = "Log GDP per capita",
    "gdpcap_log_within" = "Log GDP per capita (within)",
    "gdpcap_log_between" = "Log GDP per capita (between)",
    "un_trade_pct_gdp" = "Trade as % of GDP",
    "un_trade_pct_gdp_within" = "Trade as % of GDP (within)",
    "un_trade_pct_gdp_between" = "Trade as % of GDP (between)",
    "armed_conflictTRUE" = "Armed conflict",
    "(Intercept)[1]" = "Cutpoint 1/2",
    "(Intercept)[2]" = "Cutpoint 2/3",
    "(Intercept)[3]" = "Cutpoint 3/4",
    "(Intercept)[4]" = "Cutpoint 4/5",
    "(Intercept)" = "Intercept"
  )
}

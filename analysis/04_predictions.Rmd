...
# E~1d~: NGO laws and latent human rights
...
# E~2d~: Civil society environment and latent human rights

```{r e2d-predictions, warning=FALSE}
seed_lhr_prediction <- 3207  # From random.org
...
```{r e2d-pred-plots, warning=FALSE}
plot_baseline <- ggplot(pred_lhr_baseline_test, 
                        aes(x = latent_hr_mean_lead1, y = Estimate)) +
  geom_abline(lty = 2) +
  geom_point(alpha = 0.5) +

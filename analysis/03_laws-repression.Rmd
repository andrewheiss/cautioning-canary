...
withr::with_dir(here::here(), {
  ...
  tar_load(c(models_tbl_e1a_re, models_tbl_e1b_re, 
             models_tbl_e1c_re, models_tbl_e1d_re))
...
mfx <- models %>% 
  filter(str_detect(model, "clphy"), !str_detect(model, "new|baseline")) %>% 
...
mfx <- models %>% 
  filter(str_detect(model, "clpriv"), !str_detect(model, "new|baseline")) %>% 

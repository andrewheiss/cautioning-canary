...
We have `r panel_done_trimmed %>% distinct(gwcode) %>% nrow()` countries in this data, spanning `r panel_done_trimmed %>% distinct(year) %>% nrow()` possible years. Here's a lookup table of all the countries included:
...
- **Democracy**
  - Polyarchy index: `v2x_polyarchy`
  - Regimes of the world category: `v2x_regime_amb`
